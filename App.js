...
var alpha = prompt("enter a single char number or special char");
...
var a1 = prompt("enter fisrt angle of triangle");
var an1 = parseInt(a1);
var a2 = prompt("enter second angle of triangle");
var an2 = parseInt(a2);
var a3 = prompt("enter third angle of triangle");
var an3 = parseInt(a3);
var sum = an1 + an2 + an3;
if (sum == 180) {
...
var num = prompt("enter number of side of the shap");
var side = parseInt(num);
if (side == 3) {
